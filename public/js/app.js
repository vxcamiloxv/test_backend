        ...
        $.ajax({
            ...
            if (res && res.data) {
                ...
                for (i = 0; i < res.data.length; i++) {
                    content += "<tr>" + "<td class='table-text'><div>" + res.data[i].plate + "</div></td>" + "<td class='table-text'><div>" + res.data[i].brand + "</div></td>" + "<td class='table-text'><div>" + res.data[i].model + "</div></td>" + "<td>" + "<button id='vehicle-delete' class='btn btn-danger' data-vehicle='" + res.data[i].id + "'>" + "<i class='fa fa-btn fa-trash'></i>Delete" + "</button>" + "</form>" + "</td>" + "</tr>";
                }
            }
